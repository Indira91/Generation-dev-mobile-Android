...
import com.generation.sqlitecomroom.databinding.FragmentCreateUsuarioBinding

class CreateUsuarioFragment : Fragment() {

    private lateinit var binding: FragmentCreateUsuarioBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCreateUsuarioBinding.inflate(layoutInflater, container, false)
    ...
    fun inserirNoBanco(){
        ...
        if(verificarCampos(nome, sobrenome, idade)){
            ...
            findNavController().navigate(R.id.action_createUsuarioFragment_to_listUsuariosFragment2)
        }else{
